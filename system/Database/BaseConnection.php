...
abstract class BaseConnection implements ConnectionInterface
{
    ...
    public function listTables(bool $constrainByPrefix = false)
    {
		...
		//echo print_r ('baseConnection-listTables-ok1',true);
		////echo print_r ($this->dataCache,true);
		//echo print_r ('ok1',true);
    ...
    {
		//echo print_r ('baseConnection-tableExists-ok1',true);
		////echo print_r ($this->dataCache,true);
		//echo print_r ('ok1',true);
    ...
    {
	    //echo print_r ('baseConnection-getFieldNames-ok1',true);
		////echo print_r ($this->dataCache,true);
		//echo print_r ('ok1',true);	
    ...
    {
		//echo print_r ('BaseConec-resetDataCache-ok1',true);
