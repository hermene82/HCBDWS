...
class Model extends BaseModel
{
    ...
    {
		//echo print_r ($table,true);
		//echo print_r ('ok2',true);
        // Check for an existing Builder
        if ($this->builder instanceof BaseBuilder) {
            // Make sure the requested table matches the builder
			//echo print_r ($table,true);
		    //echo print_r ('ok21',true);
			
			//echo print_r ($this->builder->getTable(),true);
		    //echo print_r ('ok22',true);
			
            if ($table && $this->builder->getTable() !== $table) {
                //echo print_r ($table,true);
		        //echo print_r ('ok3',true);
				return $this->db->table($table);
            }
			
			//echo print_r ($table,true);
		    //echo print_r ('ok31',true);
    ...
    public function __call(string $name, array $params)
    {
		...
		//echo print_r ('Model-call-ok008',true);
        $builder = $this->builder();
        $result  = null;
        //echo print_r ('ok00801fin',true);
